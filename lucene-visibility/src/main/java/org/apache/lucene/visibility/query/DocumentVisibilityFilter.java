 ...
 */
package org.apache.lucene.visibility.query;
...
public class DocumentVisibilityFilter extends Filter {
  ...
  private final Authorizations _authorizations;

  public DocumentVisibilityFilter(String fieldName, Authorizations authorizations) {
  ...
  public DocIdSet getDocIdSet(AtomicReaderContext context, Bits acceptDocs) throws IOException {
    ...
    BytesRef bytesRef;
    VisibilityEvaluator visibilityEvaluator = new VisibilityEvaluator(_authorizations);
